...
python train_cond_tranduct.py --dataset ogbn-arxiv --nlayers=2 --sgc=1 --lr_feat=0.01 --gpu_id=3  \
...
python train_gcond_induct.py --dataset flickr --sgc=2 --nlayers=2 --lr_feat=0.005  --gpu_id=0  \ 
