...
class SageConvolution(Module):
    ...
    def __init__(self, in_features, out_features, with_bias=True, root_weight=True): # root_weight=True
...
class GraphSage(nn.Module):
    ...
    def __init__(self, nfeat, nhid, nclass, nlayers=2, dropout=0.5, lr=0.01, weight_decay=5e-4,
            with_relu=True, with_bias=True, with_bn=False, device=None): # with_bn=True
